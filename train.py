...
train_set = dset.ImageFolder(root='/content/drive/MyDrive/DataSet/train',transform = transforms.Compose([
                                transforms.RandomResizedCrop(224),
                                transforms.RandomHorizontalFlip(),
                                transforms.ToTensor()
                               ]))

validation_set = dset.ImageFolder(root='/content/drive/MyDrive/DataSet/val',transform = transforms.Compose([
